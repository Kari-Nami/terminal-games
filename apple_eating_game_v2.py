...
def main(stdscr):
    ...
    print_board()
    print_leaderboard()
    window.addstr(24, 0, f'{apple_y, apple_x}')
    ...
    while timer > 0:
        ...
        # add apple(s)
        window.addstr(apple_y, apple_x, apple)
        ...
        window.refresh()  # display everything
        ...
        if character_x == apple_x and character_y == apple_y:
            window.addstr(apple_y, apple_x, ' ')  # erase apple visual
            if super_apple_x != 0 and super_apple_y != 0: window.addstr(super_apple_y, super_apple_x, ' ')  # erase super apple visual
        ...
        if character_x == super_apple_x and character_y == super_apple_y:
            window.addstr(super_apple_y, super_apple_x, ' ')  # erase super apple visual
            window.addstr(apple_y, apple_x, ' ')  # erase apple visual
...
def move():
    ...
    window.addstr(character_y, character_x, ' ')
